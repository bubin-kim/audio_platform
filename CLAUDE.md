...
- 🔄 **본녹음 015·024·045·049**: 라벨 확정(015 벽O/후방/90°/30m · 024 벽O/전방/
  90°/30m · 045 벽X/전방/180°/30m · 049 벽X/전방/90°/10m, 전부 아파트·기둥있음) →
  **로컬 업로드+커팅 완료**, 결과 015·024·045 10/10, **049 9/10**(대역 상시 소음
  때문 — 기존 규명 사항, 신규 문제 아님). **실서버 미반영**: 원본(~58MB, 10분)이
  Railway 에지 프록시 **300초 하드 타임아웃**에 걸림(신규 발견, docs/21 §5-14).
  다음 세션 결정 필요.
- **최신 마일스톤 커밋**: `385970c` (V2-9 대역 집계 최대값, 실서버 반영 완료).
  015·024·045·049는 로컬 전용이라 이 항목은 별도 커밋 없음(docs/21 §3-4).
