...
- ✅ **V2-9 확정판**: 경보음 탐지 파이프라인 + **GT 기반 평가 체계** — `434392a`
  ...
  - **한계**(docs/17 §2g): 청취 확인 결과 오탐(84.2초)이 진짜 경보음(87초)보다
...
- ✅ **본녹음 015·024·045·049 실서버 반영 완료** 2026-08-21 (docs/21 §3-5):
  ...
  049 벽X/전방/90°/10m, 전부 아파트·기둥있음). Railway 300초 타임아웃 원인을
